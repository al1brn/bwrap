...
class Duplicator():
    ...
    def rotation_quaternions(self):
        return getattrs(self.collection.objects, "rotation_quaternion", 4, np.float)

    @rotation_quaternions.setter
    def rotation_quaternions(self, value):
        setattrs(self.collection.objects, "rotation_quaternion", value, 4)

    @property
    def rotation_axis_angles(self):
        return getattrs(self.collection.objects, "rotation_axis_angle", 4, np.float)

    @rotation_axis_angles.setter
    def rotation_axis_angles(self, value):
        setattrs(self.collection.objects, "rotation_axis_angle", value, 4)
