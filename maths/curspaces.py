...
class CurvedSpace():
    ...
    def invert_basis(self, X, basis=None):
        ...
        if not self.basis_is_inversible:
            raise WError(f"The space dimension is {self.dim}, the shape of the basis is {basis.shape}. It can't be inverted!",
                    Class = "CurvedSpace",
                    self_type = type(self),
                    Method = "invert_basis",
                    X = a2s(X),
        ...
        try:
            ...
            raise WError(f"The space dimension is {self.dim}, the shape of the basis is {basis.shape}.\n" +
    ...
    def space_to_map(self, X, V, invert=None):
        ...
        try:
            ...
            raise WError(f"The space dimension is {self.dim}, the shape of the basis is {self.basis.shape}.",
                    Class = "CurvedSpace",
                    self_type = type(self),
                    Method = "space_to_map,",
                    X = a2s(X),
